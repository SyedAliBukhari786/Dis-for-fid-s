...
public class allcountrycomplains extends FirestoreRecyclerAdapter<UserModel, allcountrycomplains.NoteHolder>{
     ...
     * @param options
     */
    public allcountrycomplains(@NonNull FirestoreRecyclerOptions<UserModel> options) {
        super(options);
    }
