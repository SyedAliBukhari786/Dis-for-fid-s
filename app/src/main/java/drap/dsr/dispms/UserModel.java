...
public class UserModel {
    ...
    private String TYPE;
    private Date Complain_Date; // new field for complain date

    public UserModel(String address, String city, String contact, String dosage_Form, String ID, String location, String name, String name_of_Drug, String remarks, String TYPE, Date complain_Date) {
        Address = address;
        City = city;
        Contact = contact;
